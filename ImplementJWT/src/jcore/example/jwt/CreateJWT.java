...
public class CreateJWT {
	...
	public static String createJWTNosign(String custName, String custEmail) throws InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException {
		jwt = Jwts.builder().claim("name", custName)
				.claim("email", custEmail)
				.setSubject("nghia")
	...
	public static Jws<Claims> parseJwt(String jwtString) throws NoSuchAlgorithmException, InvalidKeySpecException{
